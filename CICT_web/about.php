    ...
    <body>
        ...
        <div class="container mb-5 mt-5">
            ...
            <div class="row mt-4">
                ...
                <div class="col-md-4 text-center">
                    <i class="bi bi-person-circle" id="profile"></i>
                    <h6>Castro, Christian David</h6>
                </div>

                <div class="col-md-4 text-center">
                    <i class="bi bi-person-circle" id="profile"></i>
                    <h6>Leonor, John Michael</h6>
                </div>
            </div>

            <div class="row mt-4">
                <div class="col-md-4 text-center" id="pers">
                    <i class="bi bi-person-circle" id="profile"></i>
                    <h6>Lunita, Lance Raeven</h6>
                </div>

                <div class="col-md-4 text-center" id="pers">
                    <i class="bi bi-person-circle" id="profile"></i>
                    <h6>Sanchez, Marcus Frederick</h6>
                </div>
                <div class="col-md-4 text-center" id="pers">
                    <i class="bi bi-person-circle" id="profile"></i>
                    <h6>Nicolas, Williard</h6>
                </div>
            </div>
        </div>
