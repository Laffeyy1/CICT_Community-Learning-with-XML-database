                                    ...
                                    if ($user['uid'] == $user_id = $_SESSION["uid"]){
                                        ...
                                        if($notTaken == 0){
                                            if ($totalScore >= 35) {
                                                ...
                                                ?>
                                                <a class="btn btn-danger" href="certificate_generate.php" target="_blank">Print Certificate</a>
                                                <?php
                                            }
                                        }
                                    }
                            ...
                            <div class="col mx-4">
                                <div>
                                    ...
                                    if($user["uid"] == $user_id){
                                        foreach($user->quiz as $quiz){
                                            $quiz_count++;
                                            echo "Quiz No. ".$quiz_count.": ";
                                            if(!empty($quiz)) {
                                                $hdrd = $quiz * 20;
                                            ?>  
                                            <div class="progress mb-2">
                                                <div class="progress-bar bg-danger" role="progressbar" style="width: <?php echo $hdrd?>%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"><?php echo $quiz?></div>
                                            </div>
                                            <?php 
                                                $quiz_score += intval($quiz);
                                            }
                                        }
                                        ...
                                        $total_score = $quiz_score + $assess_score;
            

                                        echo "<br><br><br>Quiz score: ".$quiz_score."<br>";
                                        }
                                    }
                                    ?>
                                </div>
                        ...
                        <div class="modal-header">
                            ...
                            <div class="modal-body text-center">
                                ...
                                <div class="modal-footer my-3">
                                    ...
                                    <form action="" method="post">
                                    <div class="row my-2">
                                        <input type="hidden" name="delete_uid" class="form-control border" id="delete_uid" value="<?php echo $user_id?>">
